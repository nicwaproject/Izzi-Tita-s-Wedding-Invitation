document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('coupleNames').textContent = coupleNames || 'Izzi & Tita'; // Default names
...
function calculateCountdown() {
    const weddingDate = new Date('2024-12-15T10:00:00'); // Set your wedding date and time here (e.g., 3:00 PM)
